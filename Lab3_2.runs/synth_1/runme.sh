...
HD_PWD='C:/Users/Malav/Documents/EE316Lab/LabWork/Lab3_2/Lab3_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log segment_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source segment_display.tcl
