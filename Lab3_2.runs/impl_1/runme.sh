...
HD_PWD='C:/Users/Malav/Documents/EE316Lab/LabWork/Lab3_2/Lab3_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log segment_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source segment_display.tcl -notrace
